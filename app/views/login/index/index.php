...
<div id="login" class="page-container center-block">
        ...
        <div class="panel-body">
            ...
            <form method="post">
                ...
                <div class="form-group">
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="<?php echo UsersManager::USER_REMEMBER_ME; ?>"> Mantener la sesión iniciada
                        </label>
                    </div>
                </div>
                <div class="form-group">
                    <button class="btn btn-primary" name="<?php echo UsersManager::FORM_SUBMIT; ?>" value="<?php echo UsersManager::FORM_SUBMIT; ?>">Conectar</button>
                </div>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <a href="<?php echo $siteUrl; ?>"><span class="glyphicon glyphicon-arrow-left"></span> Volver a la pagina principal.</a>
        </div>
    </div>
</div>
