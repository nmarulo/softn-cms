...
/**
 * Modulo modelo: Gestiona grupos de relaciones post-categoría.
 */
...
/**
 * Clase PostsCategories para gestionar grupos de relaciones post-categoría.
...
class PostsCategories extends BaseModels {
    ...
    /**
     * Método que obtiene todos las relaciones post-categoría de la base de datos.
    ...
    /**
     * Método que obtiene un array con los datos de la relación post-categoría y los agrega a la lista.
     *
    ...
    /**
     * Método que agrega las relaciones post-categoría.
     *
    ...
    /**
     * Método que obtiene todos los identificadores(ID) de las categorías vinculadas a un post.
     *
    ...
    /**
     * Método que obtiene todos los identificadores(ID) de los posts vinculados a un categoría.
     *
    ...
    /**
     * Método que obtiene todos identificadores(ID) de los post vinculados a una categoría.
     *
