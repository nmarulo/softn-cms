...
use SoftnCMS\controllers\themes\CommentsTemplate;
...
class PostTemplate {
    ...
    public function getPostUrl($isEcho = \TRUE) {
        ...
        if (!$isEcho) {
            ...
            return $urlSite . 'post/' . $this->getID(\FALSE);
        }

        echo $urlSite . 'post/' . $this->getID(\FALSE);
    }
    ...
    public function getPostAuthor($isEcho = \TRUE) {
        if (!$isEcho) {
            ...
            return $this->post->getUser()->getUserName();
        }

        echo $this->post->getUser()->getUserName();
    }
    ...
    public function getPostUrlAuthor($isEcho = \TRUE) {
        ...
        if (!$isEcho) {
            ...
            return $urlSite . 'author/' . $this->post->getUserID();
        }

        echo $urlSite . 'author/' . $this->post->getUserID();
    }
    ...
    private function postComments() {
        $comments = Comments::selectByPostID($this->getID());
