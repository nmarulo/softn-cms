                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            foreach ($data['categories'] as $category) {
                                ...
                                $output .= '<a class="btnAction-sm btn btn-danger" href="' . $data['siteUrl'] . 'admin/category/delete/' . $category->getID() . '" title="Editar"><span class="glyphicon glyphicon-remove-sign"></span></a> ';
                                $output .= '</td>';
