...
$siteUrl = ViewController::getViewData('siteUrl') . "admin/license/";
?>
<div class="page-container" data-menu-collapse-id="user" data-url="<?php echo $siteUrl; ?>" data-reload-view="data" data-reload-action="index">
    <div>
        <h1><?php echo __('Permisos'); ?> <a href="<?php echo $siteUrl . 'create'; ?>" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span></a></h1>
    </div>
